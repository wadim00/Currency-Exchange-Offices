...
//---------------------------------------------------------------------------
float pricebuy ( string str) //Функція пошуку ціни BUY
{int k=0;
stringstream ssa;
string buf1;
string rezult1;
 ...
 if (str[i]==';') {k++;}
 if (k==4 && str[i]!=';') {if (str[i]=='.'){str[i]=',';} ssa<<str[i]; ssa>>buf1; rezult1+=buf1; ssa.clear(); buf1.clear();}
 }
 return StrToFloat(rezult1.c_str());
 }
float pricesell ( string str)        //Функція пошуку ціни SELL
{int k=0;
stringstream ssa;
string buf1;
string rezult1;
 for (unsigned int i =0; i < str.length(); i++) {
 if (str[i]==';') {k++;}
 if (k==5 && str[i]!=';') {if (str[i]=='.'){str[i]=',';} ssa<<str[i]; ssa>>buf1; rezult1+=buf1; ssa.clear(); buf1.clear();}
 }
 return StrToFloat(rezult1.c_str());
 }
...
string rezult1;
 for (unsigned int i =0; i < str.length(); i++) {
 if (str[i]==';') {k++;}
 if (k==6 && str[i]!=';' && c!=6) {if (str[i]=='.'){str[i]=',';} ssa<<str[i]; ssa>>buf1; rezult1+=buf1; ssa.clear(); buf1.clear();c++;}
 }
 return StrToFloat(rezult1.c_str());
 }
...
string rezult1;
 for (unsigned int i =0; i < str.length(); i++) {
 if (str[i]==';') {k++;}
 if (k==7 && str[i]!=';' && c!=6) {if (str[i]=='.'){str[i]=',';} ssa<<str[i]; ssa>>buf1; rezult1+=buf1; ssa.clear(); buf1.clear();c++;}
 }
 return StrToFloat(rezult1.c_str());
 }
...
{
/*float usdbuy[3];     float usdsell[3];    float usdamount[3];
float eurbuy[3];     float eursell[3];
for (int i=0; i <=2; i++) {
   usdbuy[i]=0;
   usdsell[i]=0;
   eurbuy[i]=0;
 ...
 int counterusd=0,      //лічильники масивів для збереження цін та порогів знижок
	 countereur=0;
string buff;
...
while (!file.eof()){
  ...
  getline(file,buff);
 if ((find(buff)==1) && counterusd!=3) {usdbuy[counterusd]=pricebuy(buff); usdsell[counterusd]=pricesell(buff); usdamount[counterusd]=priceamount(buff); counterusd++;}
buff.clear();
 }
file.close();
sort(usdbuy,3);   sort1(usdsell,3);
arrayUnique(usdbuy,3);     arrayUnique(usdsell,3);

stringstream ss,ss1,ss2;
 // Вивід usdbuy usdsell
  for (int i=0; i<arrayUnique(usdbuy,3); i++) {
 if (usdbuy[i]!=0) {
  ss<<usdbuy[i];
  ss1<<usdsell[i];
  ss2<<usdamount[i];
 ...
 ss1>>s1;
 ss2>>s2;
   if (i==0){ Label1->Caption=s.c_str();Label2->Caption=s1.c_str();}
	  if(i==1) {Label17->Caption=s.c_str();Label18->Caption=s1.c_str();Label33->Caption=s2.c_str();}
		 if (i==2){Label41->Caption=s.c_str();Label42->Caption=s1.c_str();Label57->Caption=s2.c_str();}
...
k=1;
Screen->MonitorCount; //возвращает количество мониторов
TRect Bounds = Screen->Monitors[1]->BoundsRect; //для второго монитора Monitors[1]
Form1->SetBounds(Bounds.Left, Bounds.Top, Bounds.Width(), Bounds.Height());
Label1->Font->Name="Tw Cen MT Condensed Extra Bold";
Label1->Font->Color=clRed;
Label1->Font->Size=Form1->Height/15;

Label2->Font->Name="Tw Cen MT Condensed Extra Bold";
Label2->Font->Color=clRed;
Label2->Font->Size=Form1->Height/15;
...
Label57->Font->Name="Tw Cen MT Condensed Extra Bold";
Label57->Font->Color=clWhite;
...
Label65->Font->Name="Times New Roman";
Label65->Font->Color=clBlack;


Label66->Font->Name="Times New Roman";
Label66->Font->Color=clRed;


Label67->Font->Name="Times New Roman";
Label67->Font->Color=clRed;
////////////////////////////////////////////////////////////////////////////////////////
							   //ЗВИЧАЙНІ ЦІНИ//
////////////////////////////////////////////////////////////////////////////////////////
  Label1->SetBounds(
	ClientWidth/50 - Label1->ClientWidth/2,
	ClientHeight/6.4 - Label1->ClientHeight/2,
	Label1->ClientWidth,
	Label1->ClientHeight
  );
  Label1->Font->Size=Form1->Height/15;
  ...
  Label2->SetBounds(
	ClientWidth/4.9 - Label2->ClientWidth/2,
	ClientHeight/6.4 - Label2->ClientHeight/2,
	Label2->ClientWidth,
	Label2->ClientHeight
  );
  Label2->Font->Size=Form1->Height/15;
   ...
   Label3->SetBounds(
	ClientWidth/50 - Label3->ClientWidth/2,
  ...
  Label4->SetBounds(
	ClientWidth/4.9 - Label4->ClientWidth/2,
  ...
  Label4->Font->Size=Form1->Height/15;
   ...
   Label5->SetBounds(
	ClientWidth/50 - Label5->ClientWidth/2,
  ...
  Label6->SetBounds(
	ClientWidth/4.9 - Label6->ClientWidth/2,
  ...
  Label7->SetBounds(
	ClientWidth/50 - Label7->ClientWidth/2,
  ...
  Label7->Font->Size=Form1->Height/15;
   ...
   Label8->SetBounds(
	ClientWidth/4.9 - Label8->ClientWidth/2,
  ...
  Label8->Font->Size=Form1->Height/15;
   ...
   Label9->SetBounds(
	ClientWidth/50 - Label9->ClientWidth/2,
  ...
  Label10->SetBounds(
	ClientWidth/4.9 - Label10->ClientWidth/2,
  ...
  Label11->SetBounds(
	ClientWidth/50 - Label11->ClientWidth/2,
  ...
  Label11->Font->Size=Form1->Height/15;
   ...
   Label12->SetBounds(
	ClientWidth/4.9 - Label12->ClientWidth/2,
  ...
  Label12->Font->Size=Form1->Height/15;
   ...
   Label13->SetBounds(
	ClientWidth/50 - Label13->ClientWidth/2,
  ...
  Label14->SetBounds(
	ClientWidth/4.9 - Label14->ClientWidth/2,
  ...
  Label15->SetBounds(
	ClientWidth/50 - Label15->ClientWidth/2,
  ...
  Label16->SetBounds(
	ClientWidth/4.9 - Label16->ClientWidth/2,
...
////////////////////////////////////////////////////////////////////////////////////////
   ...
   Label17->SetBounds(
	ClientWidth/2.8 - Label17->ClientWidth/2,
	ClientHeight/6.4 - Label17->ClientHeight/2,
	Label17->ClientWidth,
  ...
  Label18->SetBounds(
	ClientWidth/1.85 - Label18->ClientWidth/2,
	ClientHeight/6.4 - Label18->ClientHeight/2,
	Label18->ClientWidth,
  ...
  Label19->SetBounds(
	ClientWidth/2.8 - Label19->ClientWidth/2,
  ...
  Label20->SetBounds(
	ClientWidth/1.85 - Label20->ClientWidth/2,
  ...
  Label21->SetBounds(
	ClientWidth/2.8 - Label21->ClientWidth/2,
  ...
  Label22->SetBounds(
	ClientWidth/1.85 - Label22->ClientWidth/2,
  ...
  Label22->Font->Size=Form1->Height/15;
	...
	Label23->SetBounds(
	ClientWidth/2.8 - Label23->ClientWidth/2,
  ...
  Label24->SetBounds(
	ClientWidth/1.85 - Label24->ClientWidth/2,
  ...
  Label24->Font->Size=Form1->Height/15;
	...
	Label25->SetBounds(
	ClientWidth/2.8 - Label25->ClientWidth/2,
  ...
  Label26->SetBounds(
	ClientWidth/1.85 - Label26->ClientWidth/2,
  ...
  Label26->Font->Size=Form1->Height/15;
	...
	Label27->SetBounds(
	ClientWidth/2.8 - Label27->ClientWidth/2,
  ...
  Label28->SetBounds(
	ClientWidth/1.85 - Label28->ClientWidth/2,
  ...
  Label28->Font->Size=Form1->Height/15;
	...
	Label29->SetBounds(
	ClientWidth/2.8 - Label29->ClientWidth/2,
  ...
  Label30->SetBounds(
	ClientWidth/1.85 - Label30->ClientWidth/2,
  ...
  Label30->Font->Size=Form1->Height/15;
	...
	Label31->SetBounds(
	ClientWidth/2.8 - Label31->ClientWidth/2,
  ...
  Label32->SetBounds(
	ClientWidth/1.85 - Label32->ClientWidth/2,
 ...
 ///////////////////////////////////////////////////////////////////////////////////////
							   //Середній поріг
Label33->SetBounds(
	ClientWidth/2.04 - Label33->ClientWidth/2,
	ClientHeight/6.0 - Label33->ClientHeight/2,
	Label33->ClientWidth,
	Label33->ClientHeight
  );
  Label33->Font->Size=Form1->Height/30;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
  Label57->SetBounds(
	ClientWidth/1.21 - Label57->ClientWidth/2,
	ClientHeight/6.0 - Label57->ClientHeight/2,
	Label57->ClientWidth,
	Label57->ClientHeight
  );
  Label57->Font->Size=Form1->Height/30;
...
////////////////////////////////////////////////////////////////////////////////////////
 Label41->SetBounds(
	ClientWidth/1.44 - Label41->ClientWidth/2,
	ClientHeight/6.4 - Label41->ClientHeight/2,
	Label41->ClientWidth,
	Label41->ClientHeight
  );
  Label41->Font->Size=Form1->Height/15;

  Label42->SetBounds(
	ClientWidth/1.120 - Label42->ClientWidth/2,
	ClientHeight/6.4 - Label42->ClientHeight/2,
	Label42->ClientWidth,
	Label42->ClientHeight
  );
  Label42->Font->Size=Form1->Height/15;

  Label43->SetBounds(
	ClientWidth/1.44 - Label43->ClientWidth/2,
  ...
  Label44->SetBounds(
	ClientWidth/1.12 - Label44->ClientWidth/2,
  ...
  Label45->SetBounds(
	ClientWidth/1.44 - Label45->ClientWidth/2,
  ...
  Label46->SetBounds(
	ClientWidth/1.12 - Label46->ClientWidth/2,
  ...
  Label46->Font->Size=Form1->Height/15;
	...
	Label47->SetBounds(
	ClientWidth/1.44 - Label47->ClientWidth/2,
  ...
  Label48->SetBounds(
	ClientWidth/1.12 - Label48->ClientWidth/2,
  ...
  Label48->Font->Size=Form1->Height/15;
	...
	Label49->SetBounds(
	ClientWidth/1.44 - Label49->ClientWidth/2,
  ...
  Label50->SetBounds(
	ClientWidth/1.12 - Label50->ClientWidth/2,
  ...
  Label50->Font->Size=Form1->Height/15;
	...
	Label51->SetBounds(
	ClientWidth/1.44 - Label51->ClientWidth/2,
  ...
  Label52->SetBounds(
	ClientWidth/1.12 - Label52->ClientWidth/2,
  ...
  Label52->Font->Size=Form1->Height/15;
	...
	Label53->SetBounds(
	ClientWidth/1.44 - Label53->ClientWidth/2,
  ...
  Label54->SetBounds(
	ClientWidth/1.12 - Label54->ClientWidth/2,
  ...
  Label54->Font->Size=Form1->Height/15;
	...
	Label55->SetBounds(
	ClientWidth/1.44 - Label55->ClientWidth/2,
  ...
  Label56->SetBounds(
	ClientWidth/1.12 - Label56->ClientWidth/2,
...
////////////////////////////////////////////////////////////////////////////////////////
  Image2->SetBounds(
	ClientWidth/8.5 - Image2->ClientWidth/2,
	ClientHeight/11 - Image2->ClientHeight/2,
	Image2->ClientWidth,
	Image2->ClientHeight
  );
  ...
  Image3->SetBounds(
	ClientWidth/3.3 - Image3->ClientWidth/2,
	ClientHeight/11 - Image3->ClientHeight/2,
	Image3->ClientWidth,
	Image3->ClientHeight
  );
  ...
  Image4->SetBounds(
	ClientWidth/2.2 - Image4->ClientWidth/2,
	ClientHeight/11 - Image4->ClientHeight/2,
	Image4->ClientWidth,
	Image4->ClientHeight
  );
  ...
  Image5->SetBounds(
	ClientWidth/1.62 - Image5->ClientWidth/2,
	ClientHeight/11 - Image5->ClientHeight/2,
	Image5->ClientWidth,
	Image5->ClientHeight
  );
  ...
  Image6->SetBounds(
	...
	ClientHeight/11 - Image6->ClientHeight/2,
	Image6->ClientWidth,
	Image6->ClientHeight
  );
  ...
  Image7->SetBounds(
	...
	ClientHeight/11 - Image7->ClientHeight/2,
	Image7->ClientWidth,
	Image7->ClientHeight
  );
...
////////////////////////////////////Звичайна ціна, великий опт, середній опт///////////////////////
Label65->SetBounds(
	ClientWidth/15 - Label65->ClientWidth/2,
	ClientHeight/150 - Label65->ClientHeight/2,
	Label65->ClientWidth,
	Label65->ClientHeight
  );
  Label65->Font->Size=Form1->Height/30;

	Label66->SetBounds(
	ClientWidth/2.4 - Label66->ClientWidth/2,
	ClientHeight/150 - Label66->ClientHeight/2,
	Label66->ClientWidth,
	Label66->ClientHeight
  );
  Label66->Font->Size=Form1->Height/30;

  Label67->SetBounds(
	ClientWidth/1.3 - Label67->ClientWidth/2,
	ClientHeight/150 - Label67->ClientHeight/2,
	Label67->ClientWidth,
	Label67->ClientHeight
  );
  Label67->Font->Size=Form1->Height/30;
...
{ /*char* lastchange;
do {
	lastchange =data_izm("info.mdb");
	String filename ="info.mdb";
	...
	Label1->Caption=Form1->DBGrid1->Fields[5]->AsString + "0";
	Label2->Caption=Form1->DBGrid1->Fields[6]->AsString + "0";

	float priceusd=StrToFloat(Form1->DBGrid1->Fields[5]->AsString);

	while (Form1->DBGrid1->Fields[2]->AsString != "EUR")
	{Form1->DBGrid1->DataSource->DataSet->Next();}
	Label3->Caption=Form1->DBGrid1->Fields[5]->AsString + "0";
	Label4->Caption=Form1->DBGrid1->Fields[6]->AsString + "0";
	float priceeur=StrToFloat(Form1->DBGrid1->Fields[5]->AsString);
	Form1->DBGrid1->DataSource->DataSet->First();



	while (Form1->DBGrid1->Fields[2]->AsString != "RUB")
	{Form1->DBGrid1->DataSource->DataSet->Next();}
	Label5->Caption=Form1->DBGrid1->Fields[5]->AsString + "0";
	Label6->Caption=Form1->DBGrid1->Fields[6]->AsString + "0";
	float pricerub=StrToFloat(Form1->DBGrid1->Fields[5]->AsString);
	Form1->DBGrid1->DataSource->DataSet->First();

	while (Form1->DBGrid1->Fields[2]->AsString != "MDL")
	{Form1->DBGrid1->DataSource->DataSet->Next();}
	Label7->Caption=Form1->DBGrid1->Fields[5]->AsString + "0";
	Label8->Caption=Form1->DBGrid1->Fields[6]->AsString + "0";
	Form1->DBGrid1->DataSource->DataSet->First();

	while (Form1->DBGrid1->Fields[2]->AsString != "ROL")
	{Form1->DBGrid1->DataSource->DataSet->Next();}
	Label9->Caption=Form1->DBGrid1->Fields[5]->AsString + "0";
	Label10->Caption=Form1->DBGrid1->Fields[6]->AsString + "0";
	Form1->DBGrid1->DataSource->DataSet->First();

	while (Form1->DBGrid1->Fields[2]->AsString != "GBP")
	{Form1->DBGrid1->DataSource->DataSet->Next();}
	Label11->Caption=Form1->DBGrid1->Fields[5]->AsString;
	Label12->Caption=Form1->DBGrid1->Fields[6]->AsString;
	Form1->DBGrid1->DataSource->DataSet->First();

	while (Form1->DBGrid1->Fields[2]->AsString != "CAD")
	{Form1->DBGrid1->DataSource->DataSet->Next();}
	Label13->Caption=Form1->DBGrid1->Fields[5]->AsString + "0";
	Label14->Caption=Form1->DBGrid1->Fields[6]->AsString + "0";
	Form1->DBGrid1->DataSource->DataSet->First();

	while (Form1->DBGrid1->Fields[2]->AsString != "PLN")
	{Form1->DBGrid1->DataSource->DataSet->Next();}
	Label15->Caption=Form1->DBGrid1->Fields[5]->AsString + "0";
	Label16->Caption=Form1->DBGrid1->Fields[6]->AsString + "0";
	Form1->DBGrid1->DataSource->DataSet->First();

	float value =priceusd/priceeur;   // крос курс продажа eurusd
	float value1 =priceeur/priceusd;   // крос курс купівля eurusd
	float value2 =priceusd/pricerub;    // крос курс продажа usdrub
	float value3 =pricerub/priceusd;    // крос курс купівля usdrub
	String s=FloatToStr(value);
	String s1=FloatToStr(value1);
	String s2=FloatToStr(value2);
	String s3=FloatToStr(value3);
	s.SetLength(5);
	s1.SetLength(5);
	s2.SetLength(5);
	s3.SetLength(5);
	...
	Label19->Caption=s2;
	Label20->Caption=s3;
	} while(lastchange!=data_izm("info.mdb")); */
...
void __fastcall TForm1::Label4DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label5DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label6DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label7DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label8DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label9DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label10DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label11DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label13DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label16DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label17DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label18DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label19DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label20DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label21DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label22DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label23DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
void __fastcall TForm1::Label24DblClick(TObject *Sender)
{
if (Form1->WindowState==wsMaximized) {
Form1->WindowState=wsNormal;
 Form1->BorderStyle=bsSizeable;
...
{
if(Label33->Visible == true) Label33->Visible = false;
else Label33->Visible = true;
...
if(Label57->Visible == true) Label57->Visible = false;
...
while (!file.eof()){
 ...
 if ((find(buff)==2) && countereur!=3) {eurbuy[countereur]=pricebuy(buff); eursell[countereur]=pricesell(buff); euramount[countereur]=priceamount(buff); countereur++;}
 else
 if ((find(buff)==3) && counterrub!=3) {rubbuy[counterrub]=pricebuy(buff); rubsell[counterrub]=pricesell(buff); rubamount[counterrub]=priceamount(buff); counterrub++;}
 else
 if ((find(buff)==7) && countermdl!=3) {mdlbuy[countermdl]=pricebuy(buff); mdlsell[countermdl]=pricesell(buff); mdlamount[countermdl]=priceamount(buff); countermdl++;}
 else
 if ((find(buff)==6) && counterron!=3) {ronbuy[counterron]=pricebuy(buff); ronsell[counterron]=pricesell(buff); ronamount[counterron]=priceamount(buff); counterron++;}
 else
 if ((find(buff)==4) && countergbp!=3) {gbpbuy[countergbp]=pricebuy(buff); gbpsell[countergbp]=pricesell(buff); gbpamount[countergbp]=priceamount(buff); countergbp++;}
 else
 if ((find(buff)==8) && countercad!=3) {cadbuy[countercad]=pricebuy(buff); cadsell[countercad]=pricesell(buff); cadamount[countercad]=priceamount(buff); countercad++;}
 else
 if ((find(buff)==5) && counterpln!=3) {plnbuy[counterpln]=pricebuy(buff); plnsell[counterpln]=pricesell(buff); plnamount[counterpln]=priceamount(buff); counterpln++;}
...
stringstream ss,ss1,ss2;
 // Вивід usdbuy usdsell
  for (int i=0; i<arrayUnique(usdbuy,3); i++) {
		...
		if (i==0){ Label1->Caption="";Label2->Caption="";}
		if(i==1) {Label17->Caption="";Label18->Caption="";Label33->Caption="";}
		if (i==2){Label41->Caption="";Label42->Caption="";Label57->Caption="";}
